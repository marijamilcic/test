...
public class FrmUnosRacuna extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FrmUnosRacuna
     */
    ...
    private void jbtnSacuvajRacunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSacuvajRacunActionPerformed
        try {
            ...
            racun.setPoslovniPartner(partner);
    ...
    private void srediFormu() {
        try {
            ...
            // List<Proizvod> proizvodList = Kontroler.getInstance().vratiProizvode();
            List<Proizvod> proizvodList = new ArrayList<>();
            jcbProizvod.setModel(new DefaultComboBoxModel(proizvodList.toArray()));
